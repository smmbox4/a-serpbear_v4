...
const ICON_RENDERERS: Record<string, IconRenderer> = {
   ...
   'download': ({ color, size, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
   ...
   'question': ({ color, size, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
   ...
   'caret-left': ({ color, size, xmlnsProps }) => (
   ...
   'caret-right': ({ color, size, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 256 256">
   ...
   'caret-down': ({ color, size, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 256 256">
   ...
   'caret-up': ({ color, size, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 256 256">
   ...
   'settings': ({ color, size, xmlnsProps }) => (
   ...
   'settings-alt': ({ color, size, xmlnsProps }) => (
   ...
   'hamburger': ({ color, size, xmlnsProps }) => (
   ...
   'link-alt': ({ color, size, xmlnsProps }) => (
      <svg width={size} viewBox="0 0 20 20" {...xmlnsProps}>
                     <g fill="none">
   ...
   'tracking': ({ color, size, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
   ...
   'eye-closed': ({ color, size, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
   ...
   'research': ({ color, size, xmlnsProps }) => (
      <svg width={size} viewBox="0 0 48 48" {...xmlnsProps}>
...
const Icon: React.FC<IconProps> = ({ type, color = 'currentColor', size = 16, title = '', classes = '' }) => {
   const xmlnsProps: React.SVGProps<SVGSVGElement> = { title, xmlns: 'http://www.w3.org/2000/svg', xmlnsXlink: 'http://www.w3.org/1999/xlink', preserveAspectRatio: 'xMidYMid meet' };

   const renderIcon = ICON_RENDERERS[type];

   return (
      <span className={`icon inline-block relative top-[2px] ${classes}`}>
         {renderIcon ? renderIcon({ color, size, xmlnsProps }) : null}
      </span>
   );
};
