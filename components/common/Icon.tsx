...
type IconRendererProps = {
   ...
   size: number;
   title?: string;
   xmlnsProps: React.SVGProps<SVGSVGElement>;
};

type IconRenderer = (props: IconRendererProps) => JSX.Element;

const ICON_RENDERERS: Record<string, IconRenderer> = {
   'logo': ({ color, size, title, xmlnsProps }) => (
   ...
   'loading': ({ color, size, title, xmlnsProps }) => (
   ...
   'download': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                     {title && <title>{title}</title>}
   ...
   'trash': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                     {title && <title>{title}</title>}
   ...
   'edit': ({ color, size, title, xmlnsProps }) => (
   ...
   'question': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                     {title && <title>{title}</title>}
   ...
   'caret-left': ({ color, size, title, xmlnsProps }) => (
   ...
   'caret-right': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 256 256">
                     {title && <title>{title}</title>}
   ...
   'caret-down': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 256 256">
                     {title && <title>{title}</title>}
   ...
   'caret-up': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 256 256">
                     {title && <title>{title}</title>}
   ...
   'search': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 1024 1024">
                     {title && <title>{title}</title>}
   ...
   'settings': ({ color, size, title, xmlnsProps }) => (
   ...
   'settings-alt': ({ color, size, title, xmlnsProps }) => (
   ...
   'logout': ({ color, size, title, xmlnsProps }) => (
   ...
   'reload': ({ color, size, title, xmlnsProps }) => (
   ...
   'dots': ({ color, size, title, xmlnsProps }) => (
      <svg width={size} viewBox="0 0 24 24" {...xmlnsProps}>
                     {title && <title>{title}</title>}
   ...
   'hamburger': ({ color, size, title, xmlnsProps }) => (
   ...
   'star': ({ color, size, title, xmlnsProps }) => (
      <svg width={size} viewBox="0 0 24 24" {...xmlnsProps}>
                        {title && <title>{title}</title>}
   ...
   'link-alt': ({ color, size, title, xmlnsProps }) => (
      <svg width={size} viewBox="0 0 20 20" {...xmlnsProps}>
                     {title && <title>{title}</title>}
                     <g fill="none">
   ...
   'clock': ({ color, size, title, xmlnsProps }) => (
      <svg width={size} viewBox="0 0 24 24" {...xmlnsProps}>
                     {title && <title>{title}</title>}
   ...
   'sort': ({ color, size, title, xmlnsProps }) => (
   ...
   'tags': ({ color, size, title, xmlnsProps }) => (
   ...
   'filter': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                     {title && <title>{title}</title>}
   ...
   'idea': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
   ...
   'tracking': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
   ...
   'eye-closed': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
   ...
   'target': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
   ...
   'help': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
   ...
   'date': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
   ...
   'email': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
   ...
   'scraper': ({ color, size, title, xmlnsProps }) => (
   ...
   'city': ({ color, size, title, xmlnsProps }) => (
   ...
   'research': ({ color, size, title, xmlnsProps }) => (
      <svg width={size} viewBox="0 0 48 48" {...xmlnsProps}>
                        {title && <title>{title}</title>}
   ...
   'domains': ({ color, size, title, xmlnsProps }) => (
   ...
   'lock': ({ color, size, title, xmlnsProps }) => (
      <svg {...xmlnsProps} width={size} viewBox="0 0 24 24">
                        {title && <title>{title}</title>}
...
const Icon: React.FC<IconProps> = ({ type, color = 'currentColor', size = 16, title = '', classes = '' }) => {
   const xmlnsProps: React.SVGProps<SVGSVGElement> = { xmlns: 'http://www.w3.org/2000/svg', xmlnsXlink: 'http://www.w3.org/1999/xlink', preserveAspectRatio: 'xMidYMid meet' };

   const renderIcon = ICON_RENDERERS[type];

   return (
      <span className={`icon inline-block relative top-[2px] ${classes}`}>
         {renderIcon ? renderIcon({ color, size, title, xmlnsProps }) : null}
      </span>
   );
};
