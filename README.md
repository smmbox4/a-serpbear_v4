...
| --- | --- | --- | --- | --- | --- |
| Scraping Robot (`scrapingrobot`) | Free tier (~5,000 req/mo) | Country-level (locale + language) | No – organic listings only | ~10 (no official 100) | Query string `token` (or Authorization header) |
